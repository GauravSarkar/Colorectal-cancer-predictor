...
def plot_training_losses(H, configurations, model_name=None):
    ...
    plt.ylabel("Loss")
    plt.legend()
    if model_name: plt.savefig("/content/drive/My Drive/MyImage.png".format(model_name))
    plt.show()
...
def plot_training_accuracies(H, configurations, model_name=None):
    ...
    plt.ylabel("Accuracy")
    plt.legend()
    if model_name: plt.savefig("/content/drive/My Drive/accuracy_plot.png".format(model_name))
    plt.show()
...
def plot_training_f1_scores(H, configurations, model_name=None):
    ...
    plt.ylabel("F1-Score")
    plt.legend()
    if model_name: plt.savefig("/content/drive/My Drive/f1_score_plot.png".format(model_name))
    plt.show()
